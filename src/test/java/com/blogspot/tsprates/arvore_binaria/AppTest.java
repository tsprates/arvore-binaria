...
public class AppTest {
    ...
    private ArvoreBinaria arv = new ArvoreBinaria();

    @Test
    public void testAdicionaRaiz() {
	arv.adiciona(new No(1));
	assertEquals("[1]", arv.getEmOrdem());
    }
	...
	arv.adiciona(new No(1));
	assertEquals("[1, 2]", arv.getEmOrdem());
    }
	...
	assertEquals("[1, 2, 3, 4, 5]", arv.getEmOrdem());
    }
	...
	arv.adiciona(new No(3));
	arv.remove(3);
	assertEquals("[1, 2, 4, 5]", arv.getEmOrdem());
    }
	...
	arv.adiciona(new No(3));
	arv.remove(4);
	assertEquals("[1, 2, 3, 5]", arv.getEmOrdem());
    }
	...
	arv.remove(5);
	assertEquals("[1, 2, 3, 4, 6, 7, 8]", arv.getEmOrdem());
    }
	...
	arv.adiciona(new No(6));
	arv.remove(2);
	assertEquals("[1, 3, 4, 5, 6, 7, 8]", arv.getEmOrdem());
    }
	...
	arv.adiciona(new No(6));
	arv.remove(20);
	assertEquals("[1, 2, 3, 4, 5, 6, 7, 8]", arv.getEmOrdem());
    }
	...
	arv.adiciona(new No(2));
	arv.remove(2);
	assertEquals("[]", arv.mostraOrdem(ArvoreBinaria.EM_ORDEM));
    }
	...
	assertEquals("[2, 7, 5, 8, 9]", arv.getPreOrdem());
    }
	...
	assertEquals("[5, 9, 8, 7, 2]", arv.getPosOrdem());
    }
}
